...
namespace PolicyPro360.Migrations
{
    ...
    [Migration("20250929154307_AddChatEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PolicyPro360.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "CompanyId", "PolicyId")
                        .IsUnique()
            ...
            modelBuilder.Entity("PolicyPro360.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PolicyPro360.Models.Quiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PolicyPro360.Models.QuizAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OptionIdsCsv")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("Tbl_QuizAnswer");
                });

            modelBuilder.Entity("PolicyPro360.Models.QuizOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Tbl_QuizOption");
                });

            modelBuilder.Entity("PolicyPro360.Models.QuizQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Tbl_QuizQuestion");
                });

            modelBuilder.Entity("PolicyPro360.Models.QuizResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SuggestedPolicyIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PolicyPro360.Models.Message", b =>
                {
                    b.HasOne("PolicyPro360.Models.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("PolicyPro360.Models.QuizAnswer", b =>
                {
                    b.HasOne("PolicyPro360.Models.QuizQuestion", "Question")
                        .WithMany()
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PolicyPro360.Models.QuizResult", "Result")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("PolicyPro360.Models.QuizQuestion", b =>
                {
                    b.HasOne("PolicyPro360.Models.Quiz", "Quiz")
                        .WithMany("Questions")
